...
bool CheckNeedLearnSpell(Player* player, uint32 spellId, Creature* _Creature)
{
    ...
    switch (spellId)
    {
        ...
        case 13031: return player->HasSpell(11426); break;  // Ледяная преграда (Маг)
        case 13032: return player->HasSpell(11426); break;  // Ледяная преграда (Маг)
        case 13033: return player->HasSpell(11426); break;  // Ледяная преграда (Маг)
        case 27134: return player->HasSpell(11426); break;  // Ледяная преграда (Маг)
        case 33405: return player->HasSpell(11426); break;  // Ледяная преграда (Маг)
        case 43038: return player->HasSpell(11426); break;  // Ледяная преграда (Маг)
        case 43039: return player->HasSpell(11426); break;  // Ледяная преграда (Маг)
